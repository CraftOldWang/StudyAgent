...
class LearningAgentV2JsonCodecTest {

    private final LearningAgentV2JsonCodec codec = new LearningAgentV2JsonCodec(new ObjectMapper());

    @Test
    void parsePlanShouldReadTodosFromJsonBlock() {
        LearningAgentV2JsonCodec.TodoPlanResult result = codec.parsePlan("""
                ```json
                {
                  "todos": [
